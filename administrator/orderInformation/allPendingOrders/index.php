...
try
{
  ...
  $sql = "SELECT order_t.orderID, user_t.firstName, user_t.lastName, order_t.deliveryAddress, 
            order_t.deliveryCity, order_t.deliveryState, order_t.deliveryZipcode, order_t.orderStatus, order_t.deliveryOption
          FROM order_t, user_t
...
{
  $error = 'Error fetching all pending orders: ' . $e->getMessage();
  include 'error.html.php';
  exit();
}
...
include 'allPendingOrders.html.php';